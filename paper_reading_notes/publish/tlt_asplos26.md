...
![一轮 RL step 是怎么跑的](https://ziyuhuang123.github.io/paper_reading_notes/assets/tlt_asplos26/tlt_asplos26_diagram_01_rl-step.png)
...
![SD 在做什么](https://ziyuhuang123.github.io/paper_reading_notes/assets/tlt_asplos26/tlt_asplos26_diagram_02_sd.png)

> SD 的关键不是“小模型替代大模型”，而是：**把原来很多次串行 decode step，压成一次更并行的验证步**。

### target 为什么能一次检查多个位置

![target 为什么能一次检查多个位置](https://ziyuhuang123.github.io/paper_reading_notes/assets/tlt_asplos26/tlt_asplos26_diagram_03_target.png)
...
![一轮 rollout 的形状](https://ziyuhuang123.github.io/paper_reading_notes/assets/tlt_asplos26/tlt_asplos26_diagram_04_rollout.png)
...
![TLT 总体结构](https://ziyuhuang123.github.io/paper_reading_notes/assets/tlt_asplos26/tlt_asplos26_diagram_05_tlt.png)
